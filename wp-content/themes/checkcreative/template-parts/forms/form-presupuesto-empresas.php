...
$formSteps = [
	...
	[
		...
		'title'  => __('¿Cuál es tu perfil profesional?', 'checkcreative'),
		'fields' => [
			[
				'type'    => 'radio',
				'name' => 'perfilProfesional',
				'options' => [
					'arquitecto'   => __('Arquitecto', 'checkcreative'),
					'constructor'  => __('Constructor', 'checkcreative'),
					'interiorista' => __('Interiorista', 'checkcreative'),
					'otros'        => __('Otros', 'checkcreative')
				]
			]
		],
		'button' => __('Siguiente', 'checkcreative')
	...
	[
		...
		'title'  => __('¿Qué producto te interesa?', 'checkcreative'),
		'fields' => [
			[
				'type'    => 'radio',
				'name' => 'productoInteres',
				'options' => [
					'ascensor'            => __('Ascensor', 'checkcreative'),
					'plataformaElevadora' => __('Plataforma elevadora', 'checkcreative'),
					'bespoke'             => __('Bespoke, lo quiero a medida', 'checkcreative'),
					'noClaro'             => __('No lo tengo claro', 'checkcreative')
				]
			]
		],
		'button' => __('Siguiente', 'checkcreative')
	...
	[
		...
		'title'  => __('¿Tienes planos o imágenes del proyecto?', 'checkcreative'),
		'fields' => [
			[
				'type'    => 'radio',
				'name' => 'documentos',
