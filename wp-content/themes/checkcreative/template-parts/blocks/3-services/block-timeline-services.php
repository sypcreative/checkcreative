...
?>
<section class="block-line overflow-visible container" data-line-scroll>
	<div class="block-line__wrapper">
		<svg class="block-line__svg" id="Capa_2" data-name="Capa 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1035.78 3063.93">
		...
		<?php if (!empty($images)): ?>
			<div class="process-images d-none d-md-block">
				<?php $img_i = 1; ?>
