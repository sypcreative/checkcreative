 ...
 */
function checkcreative_customizer_settings($wp_customize) {}

add_action('customize_register', 'checkcreative_customizer_settings');

function checkcreative_sanitize_select($input)
{
	$valid = array(
		'left'  => 'left',
		'right' => 'right',
 ...
 *
 * $logo_white_url = get_theme_mod('checkcreative_site_logo'); // Obtener la URL del logo
 * $logo_white_url = get_theme_mod('checkcreative_site_logo_white'); // Obtener la URL del logo para fondo blanco
 * $logo_mobile_url = get_theme_mod('checkcreative_site_logo_best');  // Obtener la URL del logo para versión móvil
 *
 * @param WP_Customize_Manager $wp_customize Objeto de la clase WP_Customize_Manager.
 */
function checkcreative_site_identity($wp_customize) {}

add_action('customize_register', 'checkcreative_site_identity');
