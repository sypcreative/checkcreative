...
function checkcreative_blocks_category($categories): array
{
	...
	$custom_block = array(
		...
		[
			'slug'  => 'checkcreative-gallery',
			'title' => __('checkcreative | Gallery', 'checkcreative'),
		],
	);
...
function checkcreative_blocks(): void
{
	...
	if (function_exists('acf_register_block')) {
		...
		acf_register_block(
			array(
				'name'            => 'block-best-projects',
				'title'           => __('Block Best Projects', 'checkcreative'),
				'post_types' => array('page'),
				'description'     => __('Bloque que contiene un slider con los proyectos destacados.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-best-projects.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-title-history',
				'title'           => __('Block Title History', 'checkcreative'),
				'post_types' => array('page'),
				'description'     => __('Bloque que un titular y un texto posicionados a derecha e izquierda respectivamente.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-title-history.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-videos',
				'title'           => __('Block Videos', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene una cuadrícula con los vlogs de youtube.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-videos.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-contact',
				'title'           => __('Block Contact', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene un título, formulario y los datos de contacto de Check Creative.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-contact.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-gallery',
				'title'           => __('Block Gallery', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene un archivo de imágenes.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-gallery.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-services-home',
				'title'           => __('Block Services Home', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene unas cards con los servicios de Check Creative.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-services-home.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-images',
				'title'           => __('Block Images', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene dos imágenes.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-images.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				...
				'title'           => __('Block Paragraphs', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene párrafos de texto.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-paragraphs.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-testimonies',
				'title'           => __('Block Testimonies', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene los testimonios de los clientes.', 'checkcreative'),
				...
				'example'         => array(
					'attributes' => array(
						'mode' => 'preview', // Important!
						'data' => array(
							'image' => '<img src="' . get_template_directory_uri() . '/assets/dist/img/blocks/block-testimonies.png' . '" style="display: block; margin: 0 auto;  max-width:100%;">'
						),
					),
				),
			)
		...
		acf_register_block(
			array(
				'name'            => 'block-mission',
				'title'           => __('Block Mission', 'checkcreative'),
				'post_types' 		=> ['page'],
				'description'     => __('Bloque que contiene la misión de Check Creative, titular y texto.', 'checkcreative'),
