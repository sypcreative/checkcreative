 ...
 * @return array
 */
function checkcreative_body_classes($classes)
{
...
add_filter('body_class', 'checkcreative_body_classes');
 ...
 */
function checkcreative_pingback_header()
{
...
add_action('wp_head', 'checkcreative_pingback_header');
...
//WOOCOMMERCE
add_filter('woocommerce_add_to_cart_fragments', 'checkcreative_mini_cart_subtotal_fragment');

function checkcreative_mini_cart_subtotal_fragment($fragments)
{
